      ...
      <main className="flex-1 flex items-center justify-center px-4 pt-28 pb-12">
        <div className="w-full max-w-3xl mx-auto">
          ...
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-3 text-right">
            {[
              { n: "۱", t: "ورود", d: "نام، موبایل و تعهدنامه. چیز بیشتری این‌جا نمی‌پرسیم." },
              { n: "۲", t: "صلاحیت", d: "۱۰ نمونه‌کار در یک شاخه، شهر، مبدأ حرکت روی نقشه، تجهیزات." },
              { n: "۳", t: "کارتابل", d: "پروژه‌های باز را ببینید؛ پیشنهادها و کارهای قطعی در «پروژه‌های من» می‌مانند." },
            ].map((step) => (
