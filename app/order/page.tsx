...
export const metadata: Metadata = {
  ...
  description:
    "ثبت سفارش آنلاین و سریع پروژه‌های عکاسی و فیلمبرداری؛ قیمت نهایی پس از انتخاب متخصص مشخص می‌شود.",
};
        ...
        fallback={
          <div className="flex h-[60vh] w-full items-center justify-center relative z-10">
            <div className="flex flex-col items-center gap-3">
              ...
              <span className="text-xs font-bold text-jar-muted">
