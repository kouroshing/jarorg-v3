    ...
    <div className="mx-auto w-full max-w-2xl animate-fade-up text-right px-4 sm:px-0" dir="rtl">
      ...
      <header className="mb-8 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs font-medium text-[#66605B]">ابزارهای هوشمند برای تسهیل فرآیندها و ارتقای فعالیت‌های شما</p>
        </div>
      </header>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        {/* Tool 1: Jaramooz Academy (Taller, Promoted to 1st place) */}
        <Link
          href="/jaramooz"
        ...
        >
          ...
          <div className="mt-4">
            ...
            <p className="mt-1.5 text-xs font-semibold text-blue-800/80">مسترکلاس‌های عکاسی، نورپردازی و کسب درآمد از هنر</p>
          </div>
        </Link>

        {/* Tool 2: Location Map (Moved to 2nd place and Locked) */}
        <div className="col-span-2 relative overflow-hidden flex h-28 flex-col justify-between rounded-2xl border border-[#E5E0D8] bg-white p-5 text-right select-none shadow-xs">
          ...
          <div>
            <h3 className="text-sm font-bold text-[#141413]">📍 نقشه لوکیشن‌ها و عمارت‌ها</h3>
            <p className="mt-1 text-[10px] font-medium text-[#66605B]">مشاهده و فیلتر لوکیشن‌های عکاسی فعال روی نقشه</p>
          </div>
        ...
        {/* Tool 3: AI Photo Edit (New tool and Locked) */}
        <div className="col-span-2 relative overflow-hidden flex h-28 flex-col justify-between rounded-2xl border border-[#E5E0D8] bg-white p-5 text-right select-none shadow-xs">
          <div className="flex w-full items-start justify-between">
          ...
          <div>
            ...
            <p className="mt-1 text-[10px] font-medium text-[#66605B]">ویرایش و روتوش سریع تصاویر با هوش مصنوعی اختصاصی</p>
          </div>
