...
export function JoinUsBanner() {
  return (
    <section
      className="w-full pb-6 sm:pb-8 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto"
      dir="rtl"
    >
          ...
          <div className="flex items-start sm:items-center gap-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs sm:text-sm text-jar-muted font-medium leading-relaxed max-w-xl">
                به جمع صدها متخصص برگزیده جار بپیوندید؛ پورتفولیوی اختصاصی خود را
                بسازید و پروژه‌های آماده دریافت کنید.
              </p>
            </div>
          </div>
