...
export default function MobileBottomNav({
  ...
  const itemClass = (active: boolean) =>
    `flex w-full max-w-full flex-col items-center justify-center gap-0.5 px-1 py-1 text-[10px] font-bold leading-none transition-all duration-300 ease-out ${
  ...
  return (
    <nav
      ...
      dir="rtl"
    >
      <ul className="pointer-events-auto grid grid-cols-4 h-16 w-full max-w-md items-center rounded-full border border-jar-border bg-jar-canvas/90 px-1.5 py-1 shadow-[0_8px_30px_rgba(31,30,29,0.06)] backdrop-blur-xl pb-[max(0.25rem,env(safe-area-inset-bottom,0px))]">
        <li className="flex min-w-0 justify-center">
          ...
          >
            <Home className="h-5 w-5 shrink-0" strokeWidth={isHome ? 2.5 : 2} />
        ...
        <li className="flex min-w-0 justify-center">
          ...
          >
            <Briefcase className="h-5 w-5 shrink-0" strokeWidth={isOrder ? 2.5 : 2} />
            <span className="whitespace-nowrap">ثبت سفارش</span>
          </Link>
        </li>
        ...
        <li className="flex min-w-0 justify-center">
          ...
          >
            <Wrench className="h-5 w-5 shrink-0" strokeWidth={isTools ? 2.5 : 2} />
            <span className="whitespace-nowrap">ابزارها</span>
          </Link>
        </li>
        ...
        <li className="flex min-w-0 justify-center">
          {isLoggedIn ? (
            ...
            >
              <User className="h-5 w-5 shrink-0" strokeWidth={isProfile ? 2.5 : 2} />
            ...
            >
              <LogIn
                ...
                strokeWidth={pathname.startsWith("/login") ? 2.5 : 2}
              />
              <span className="whitespace-nowrap">ورود</span>
            </Link>
          )}
        </li>
      </ul>
