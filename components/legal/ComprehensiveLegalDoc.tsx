              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs sm:text-sm font-bold text-[#141413]">
                ...
                <li>
                  <a href="#order-flow" className="hover:underline">
                    بخش چهارم: فرآیند ثبت سفارش و قطعی شدن رزرو
                  </a>
                </li>
                <li>
          ...
          <div className="space-y-10 text-xs sm:text-sm leading-relaxed text-slate-700">
            ...
            <section id="privacy" className="scroll-mt-24 space-y-4">
              ...
              <div className="space-y-3 pt-4">
                ...
                <ul className="list-disc list-inside space-y-2 pr-2 text-slate-700">
                  <li>
                    شماره تماس مستقیم و آدرس دقیق پلاک/واحد کارفرما تا پیش از پرداخت کامل مبلغ توافق‌شده و قطعی شدن سفارش (CONFIRMED) از دید متخصصان متقاضی پنهان (Mask) می‌ماند. شماره و نشانی دقیق معمولاً نزدیک زمان اجرای پروژه آزاد می‌شود.
                  </li>
                  <li>
                    متقابلاً شماره تماس مستقیم متخصص نیز پس از قطعی شدن همکاری در اختیار کارفرما قرار خواهد گرفت (زمان‌بندی افشا مطابق سیاست پلتفرم).
                  </li>
                </ul>
              </div>
            </section>
            ...
            <section id="definitions" className="scroll-mt-24 space-y-4 pt-6 border-t border-slate-200">
              ...
              <ul className="list-disc list-inside space-y-3 pr-2 text-slate-700">
                ...
                <li>
                  <strong className="text-slate-900">متخصص:</strong> اشخاص حقیقی صاحب صلاحیت، تجربه و تجهیزات تخصصی عکاسی و فیلم‌برداری که پس از احراز شماره تماس، انتخاب حداقل سه شاخه تخصصی، بارگذاری نمونه‌کارهای استاندارد (حداقل ۱۰ نمونه در هر یک از شاخه‌های انتخابی) و پذیرش تعهدنامه‌ها، در سامانه فعال شده‌اند.
                </li>
                <li>
                ...
                <li>
                  <strong className="text-slate-900">قطعی شدن سفارش (Deal Confirmation):</strong> تعهد قطعی اجرای پروژه پس از «انتخاب متخصص توسط کارفرما» و سپس «پرداخت مبلغ توافق‌شده توسط کارفرما» ایجاد می‌شود. اعلام آمادگی متخصص در مرحله پیشنهاد، تعهد وی به اجرای پروژه در صورت انتخاب و پرداخت است.
                </li>
              </ul>
            </section>
            ...
            <section id="membership" className="scroll-mt-24 space-y-4 pt-6 border-t border-slate-200">
              ...
              <ul className="list-disc list-inside space-y-3 pr-2 text-slate-700">
                ...
                <li>
                  <strong className="text-slate-900">غربالگری و استانداردهای پورتفولیو:</strong> جار این حق را برای خود محفوظ می‌دارد که نمایش پورتفولیو، وضعیت فعالیت (ACTIVE) و دسترسی متخصصان به فید سفارش‌ها را منوط به رعایت کفایت کیفی (از جمله انتخاب حداقل سه شاخه تخصصی و حداقل ۱۰ نمونه‌کار استاندارد در هر یک از آن‌ها) و عدم گزارش تخلف نماید.
                </li>
              </ul>
            </section>
            ...
            <section id="order-flow" className="scroll-mt-24 space-y-4 pt-6 border-t border-slate-200">
              <h2 className="text-base sm:text-lg md:text-xl font-black text-slate-950 border-b border-slate-100 pb-2">
                بخش چهارم: فرآیند ثبت سفارش، تعهدات و قطعی شدن رزرو
              </h2>
              ...
              <div className="space-y-3">
                ...
                <div className="pt-2">
                  <strong className="text-slate-900 block mb-2">چرخه قطعی شدن سفارش:</strong>
                  <ol className="list-decimal list-inside space-y-1.5 pr-2 text-slate-700">
                    <li>پس از ثبت سفارش و عبور از کنترل‌های کیفی، سفارش در تابلوی متناسب با تخصص و محدوده متخصصان منتشر می‌شود.</li>
                    <li>متخصصان با بررسی شرایط، تمایل خود را با ثبت پیشنهاد (نرخ پایه جار یا بالاتر + ایاب‌وذهاب) اعلام می‌کنند.</li>
                    <li>کارفرما از میان متقاضیان، نمونه‌کارها را بررسی و یک متخصص را انتخاب می‌نماید (AWAITING_PAYMENT).</li>
                    <li>با پرداخت مبلغ توافق‌شده توسط کارفرما، پروژه قطعی (CONFIRMED) می‌شود و گفتگوی هماهنگی روی صفحه سفارش فعال می‌گردد.</li>
                    <li>شماره تماس و نشانی دقیق معمولاً نزدیک زمان اجرای پروژه آزاد می‌شود؛ تا آن زمان هماهنگی از طریق گفتگوی درون‌سامانه‌ای انجام می‌شود.</li>
                  </ol>
                </div>
