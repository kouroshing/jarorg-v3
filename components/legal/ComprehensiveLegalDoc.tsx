          ...
          <div className="space-y-10 text-xs sm:text-sm leading-relaxed text-slate-700">
            ...
            <section id="definitions" className="scroll-mt-24 space-y-4 pt-6 border-t border-slate-200">
              ...
              <ul className="list-disc list-inside space-y-3 pr-2 text-slate-700">
                ...
                <li>
                  <strong className="text-slate-900">متخصص:</strong> اشخاص حقیقی صاحب صلاحیت، تجربه و تجهیزات تخصصی عکاسی و فیلم‌برداری که پس از احراز شماره تماس، انتخاب حداقل سه شاخه تخصصی، بارگذاری نمونه‌کارهای استاندارد (حداقل ۱۰ نمونه در یکی از شاخه‌های انتخابی) و پذیرش تعهدنامه‌ها، در سامانه فعال شده‌اند.
                </li>
                <li>
