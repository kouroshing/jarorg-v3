...
/**
 * Curated public / typically free photography spots.
 * Not scraped. Covers are the existing category mood photos (tiny, already in the app).
 * Real galleries should be uploaded once to the Liara `uploads` disk.
 */
export const FREE_JAR_LOCATION_SEED: FreeLocationSeed[] = [
  {
